...
export const fr: Dictionary = {
  meta: {
    ...
    description:
      "O&CO est une agence immobilière premium au Cameroun. Nous dénichons, mettons en scène et révélons des logements d'exception — et vous installons dans celui qui vous ressemble.",
    ogDescription:
      "Agence immobilière premium au Cameroun. Nous dénichons, mettons en scène et révélons des logements d'exception.",
    keywords: [
      "agence immobilière premium Cameroun",
      "immobilier Douala",
      "immobilier Yaoundé",
      "appartements à vendre Cameroun",
      "villas Cameroun",
      "chasseur immobilier",
      "home staging",
      "O&CO",
    ...
    items: [
      {
        ...
        description:
          "Un penthouse en dernier étage face à l'océan, terrasse panoramique, piscine privée et intérieur baigné de lumière — à deux pas de la plage à Kribi.",
        agentName: "Camille Laurent",
        agentRole: "Conseillère senior — Littoral",
      },
      {
        ...
        baths: 1,
        surface: "96 m²",
        alt: "Un appartement chaleureux, assises en cuir et vue arborée",
        summary: "Un appartement élégant à Bonapriso, double exposition.",
        description:
          "Un appartement tout en sobriété à Bonapriso — double exposition, belles finitions et vue arborée, dans l'une des meilleures adresses de Douala.",
        agentName: "Camille Laurent",
        agentRole: "Conseillère senior — Littoral",
      },
      {
        ...
        summary: "Une villa contemporaine avec jardins et piscine.",
        description:
          "Une villa contemporaine à Bastos — beaux volumes, jardins paysagers et piscine, dans le quartier le plus prestigieux de Yaoundé.",
        agentName: "Léa Fontaine",
        agentRole: "Conseillère — Centre",
      },
      {
        slug: "gallery-loft",
        name: "Loft Gallery",
        ...
        description:
          "Un loft double hauteur à Akwa — cuisine ouverte, lumière d'atelier et mur de cadres, meublé et prêt à vivre. Au cœur du centre de Douala.",
        agentName: "Camille Laurent",
        agentRole: "Conseillère senior — Littoral",
      },
      {
        ...
        description:
          "Une villa épurée, enduit blanc, face à l'océan à Limbé — baies vitrées toute hauteur, jardin mature et piscine à débordement, vue dégagée sur la baie.",
  ...
  catalog: {
    ...
    intro: "L'intégralité de notre portefeuille — vente et location, partout au Cameroun.",
    all: "Tous",
    type: "Type",
    status: "Statut",
    area: "Secteur",
  ...
  agency: {
    ...
    body: "O&CO est une agence immobilière premium au Cameroun. On déniche des biens on et off-market, on les met en scène et on les filme comme il faut, puis on vous accompagne de la première visite au jour de l'emménagement.",
    stats: [
  ...
  testimonials: {
    ...
    items: [
      {
        quote:
          "Ils nous ont trouvé un bien qui n'était même pas sur le marché — et tout a été d'une simplicité folle.",
        name: "Marie & Thomas",
        role: "Achat à Douala",
        rating: 5,
      },
  ...
  reels: {
    ...
    captions: [
      "Dans une villa face mer à Limbé 🌿",
      "Révélation penthouse — front de mer à Kribi ✨",
      "Loft à Akwa, Douala — visite complète 🤍",
      "Heure dorée à la villa de Bastos 🌅",
    ],
    music: [
      "O&CO · son original",
  ...
  team: {
    ...
    members: [
      ...
      { name: "Camille Laurent", role: "Conseillère senior — Littoral", initials: "CL" },
      { name: "Léa Fontaine", role: "Conseillère — Centre", initials: "LF" },
  ...
  areas: {
    ...
    cta: "Découvrir",
    intro: "Des biens premium aux meilleures adresses du Cameroun.",
    propertiesLabel: "biens",
    list: [
      { slug: "douala", name: "Douala", tagline: "Appartements & villas", description: "De Bonapriso à Bonanjo et Bonamoussadi — appartements, lofts et villas dans les meilleurs quartiers de la ville." },
      { slug: "yaounde", name: "Yaoundé", tagline: "Résidences & villas", description: "Bastos et les hauteurs alentour — villas familiales et résidences modernes aux adresses les plus prisées de la capitale." },
      { slug: "kribi", name: "Kribi", tagline: "Bord de mer", description: "Penthouses et villas le long de la côte, à deux pas de la plage et de la lagune." },
      { slug: "limbe", name: "Limbé", tagline: "Bord de mer", description: "Quelques-uns des biens les plus privés de la côte, jardins matures et vue sur l'océan." },
    ],
  },
  ...
  whatsapp: {
    contact: "Continuer sur WhatsApp",
    viewing: "Organiser par WhatsApp",
    contactMessage: "Bonjour O&CO, je souhaite être accompagné dans ma recherche de bien.",
    viewingMessage: "Bonjour O&CO, je souhaite organiser une visite pour",
  },
  ...
  form: {
    ...
    message: "Message",
    budgetOptions: ["À vendre", "À louer", "Sans préférence"],
    typeOptions: ["Acheter", "Louer", "Vendre", "Je me renseigne"],
    areaPlaceholder: "ex. Douala, Yaoundé…",
  ...
  footer: {
    tagline: "Agence immobilière premium au Cameroun. On déniche, on met en scène et on révèle des logements d'exception.",
