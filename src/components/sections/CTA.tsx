...
/**
 * Closing call-to-action / contact band. The primary conversion point of the
 * page, with direct email and phone links for both users and crawlers.
 */
export function CTA() {
  return (
    <section
    ...
    >
      <Container className="grid gap-14 lg:grid-cols-[1.15fr_1fr] lg:items-end">
        ...
        <dl className="grid gap-8 border-t border-cream/15 pt-10 sm:grid-cols-2 lg:border-l lg:border-t-0 lg:pl-12 lg:pt-0">
          ...
          <div>
            <dt className="text-xs uppercase tracking-[0.2em] text-cream/50">Phone</dt>
            <dd className="mt-2">
              <a
          ...
          <div className="sm:col-span-2">
            <dt className="text-xs uppercase tracking-[0.2em] text-cream/50">Studio</dt>
